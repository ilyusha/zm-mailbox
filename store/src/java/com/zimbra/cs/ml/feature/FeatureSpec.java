...
public class FeatureSpec<T extends Classifiable> {
     ...
     * This currently only returns Message feature factories; this will need
     * to be generalized if we add the ability to classify things other than messages
     */
    public FeatureFactory<T, ?> buildFactory() throws ServiceException {
        ...
        try {
            //TODO: set label in constructor to avoid having no-argument constructors everywhere
